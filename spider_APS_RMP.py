...
def spider_APS_RMP(ISS):
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://journals.aps.org/rmp/issues/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    for url in url_list:
    ...
    paper_url_list = compare_url(paper_url_list, "data\\APS_RMP.csv", "data\\Temp\\APS_RMP.csv")
    print(len(paper_url_list))
