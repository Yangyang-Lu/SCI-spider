...
def spider_Wiley_Advanced_Materials(ISS):
    url = ("https://www.onlinelibrary.wiley.com/loi/15214095")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.onlinelibrary.wiley.com/toc/15214095/" + str(1988+int(iss[0])) + "/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    for url in url_list:
    ...
    paper_url_list = compare_url(paper_url_list, "data\\Wiley_Advanced_Materials.csv", "data\\Temp\\Wiley_Advanced_Materials.csv")
    print(len(paper_url_list))
