...
def spider_Wiley_Small(ISS):
    url = ("https://onlinelibrary.wiley.com/loi/16136829")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.onlinelibrary.wiley.com/toc/16136829/" + str(2004 + int(iss[0])) + "/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    for url in url_list:
    ...
    paper_url_list = compare_url(paper_url_list, "data\\Wiley_Small.csv", "data\\Temp\\Wiley_Small.csv")
    print(len(paper_url_list))
