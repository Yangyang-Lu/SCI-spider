...
def get_page(url):
   ...
   # print(each_paper_url)
    pattern2 = r'.*/journal/corrosion-science/vol/(.*)/suppl/C.*'
    ...
    url = []
    url.append("https://www.sciencedirect.com/journal/corrosion-science/vol/" + str(vol1) + "/suppl/C")
    url.append("https://www.sciencedirect.com/journal/corrosion-science/vol/" + str(vol2) + "/suppl/C")
    #print(url)
    return str(vol), url
...
def spider_ELSEVIER_Corrosion_Science(ISS):
    url = ("https://www.sciencedirect.com/journal/corrosion-science/issues")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.sciencedirect.com/journal/corrosion-science/vol/" + str(int(iss[0])) + "/suppl/C")
        url_list.append("https://www.sciencedirect.com/journal/corrosion-science/vol/" + str(int(iss[1])) + "/suppl/C")
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    for url in url_list:
    ...
    print(len(paper_url_list))
    [paper_url_list, paper_title_list] = compare_url_title(paper_url_list, paper_title_list, "data\\ELSEVIER_Corrosion_Science.csv", "data\\Temp\\ELSEVIER_Corrosion_Science.csv")
    print(len(paper_url_list))
