...
def get_page(url):
    ...
    pattern2 = r'.*/journal/acta-materialia/vol/(.*)/suppl/C.*'
    ...
    url = []
    url.append("https://www.sciencedirect.com/journal/acta-materialia/vol/" + str(vol1) + "/suppl/C")
    url.append("https://www.sciencedirect.com/journal/acta-materialia/vol/" + str(vol2) + "/suppl/C")
    #print(url)
    return str(vol), url
...
def spider_ELSEVIER_ActaMater(ISS):
    url = ("https://www.sciencedirect.com/journal/acta-materialia/issues")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.sciencedirect.com/journal/acta-materialia/vol/" + str(int(iss[0])) + "/suppl/C")
        url_list.append("https://www.sciencedirect.com/journal/acta-materialia/vol/" + str(int(iss[1])) + "/suppl/C")
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    for url in url_list:
    ...
    print(len(paper_url_list))
    [paper_url_list, paper_title_list] = compare_url_title(paper_url_list, paper_title_list, "data\\ELSEVIER_ActaMater.csv", "data\\Temp\\ELSEVIER_ActaMater.csv")
    print(len(paper_url_list))
