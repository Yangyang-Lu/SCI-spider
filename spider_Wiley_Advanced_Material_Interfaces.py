...
def spider_Wiley_Advanced_Material_Interfaces(ISS):
    url = ("https://www.onlinelibrary.wiley.com/loi/21967350")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.onlinelibrary.wiley.com/toc/21967350/" + str(2013+int(iss[0])) + "/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    for url in url_list:
    ...
    paper_url_list = compare_url(paper_url_list, "data\\Wiley_Advanced_Materials_Interfaces.csv", "data\\Temp\\Wiley_Advanced_Materials_Interfaces.csv")
    print(len(paper_url_list))
