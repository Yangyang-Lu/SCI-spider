...
def spider_Nature_materials(ISS):
    url = ("https://www.nature.com/nmat/volumes")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.nature.com/nmat/volumes/" + str(int(iss[0])) + "/issues/" +str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    paper_abstract_list = []
    ...
    print(len(paper_url_list))
    [paper_url_list, paper_title_list, paper_abstract_list] = compare_url_title_abstract(paper_url_list, paper_title_list, paper_abstract_list, "data\\Nature_materials.csv", "data\\Temp\\Nature_materials.csv")
    print(len(paper_url_list))
