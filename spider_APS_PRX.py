...
def spider_APS_PRX(ISS):
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://journals.aps.org/prx/issues/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    for url in url_list:
    ...
    paper_url_list = compare_url(paper_url_list, "data\\APS_PRX.csv", "data\\Temp\\APS_PRX.csv")
    print(len(paper_url_list))
