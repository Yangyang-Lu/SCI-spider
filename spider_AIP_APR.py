...
def get_page(url):
    ...
    url = ("https://aip.scitation.org/toc/are/"+str(each_paper_url[0].get('data-volume'))+"/"+str(each_paper_url[0].get('data-issue')))
    #print(k)
    #print(url)
...
def spider_AIP_APR(ISS):
    url = ("https://aip.scitation.org/toc/are/current")
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://aip.scitation.org/toc/are/" + str(int(iss[0])) + "/" + str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    for url in url_list:
    ...
    print(len(paper_url_list))
    [paper_url_list, paper_title_list] = compare_url_title(paper_url_list, paper_title_list, "data\\AIP_APR.csv", "data\\Temp\\AIP_APR.csv")
    print(len(paper_url_list))
