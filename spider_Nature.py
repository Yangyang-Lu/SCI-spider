...
def spider_Nature(ISS):
    ...
    if latest_issue == ISS:
        ...
        url_list.append("https://www.nature.com/nature/volumes/" + str(int(iss[0])) + "/issues/" +str(int(iss[1])))
        print(url_list)
    paper_url_list = []
    paper_title_list = []
    paper_abstract_list = []
    ...
    print(len(paper_url_list))
    [paper_url_list, paper_title_list, paper_abstract_list] = compare_url_title_abstract(paper_url_list, paper_title_list, paper_abstract_list, "data\\Nature.csv", "data\\Temp\\Nature.csv")
    print(len(paper_url_list))
    return paper_title_list, paper_url_list, paper_abstract_list, latest_issue



#ISS = 'Vol. 605, Iss. 7908'
